...
import { DecisionsComponent } from 'app/entities/decisions/decisions.component';
...
describe('Component Tests', () => {
  describe('Decisions Management Component', () => {
    let comp: DecisionsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DecisionsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.decisions && comp.decisions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
