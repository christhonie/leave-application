...
export class LeaveTypeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.leaveTypeService
      ...
      .subscribe(
        (res: HttpResponse<ILeaveType[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLeaveTypes(): void {
    this.eventSubscriber = this.eventManager.subscribe('leaveTypeListModification', () => this.loadPage());
  }
