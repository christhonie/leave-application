...
export class StaffComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.staffService
      ...
      .subscribe(
        (res: HttpResponse<IStaff[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInStaff(): void {
    this.eventSubscriber = this.eventManager.subscribe('staffListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IStaff[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
