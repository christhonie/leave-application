...
/**
 * Criteria class for the {@link za.co.dearx.leave.domain.LeaveType} entity. This class is used
 * in {@link za.co.dearx.leave.web.rest.LeaveTypeResource} to receive all the possible filtering options from
