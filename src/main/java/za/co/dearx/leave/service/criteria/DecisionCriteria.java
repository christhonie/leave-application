...
/**
 * Criteria class for the {@link za.co.dearx.leave.domain.Decision} entity. This class is used
 * in {@link za.co.dearx.leave.web.rest.DecisionResource} to receive all the possible filtering options from
